...
public class StubInputTest {
    ...
    public void testAddNewItemAndGetItemWithSameName() {
        ...
        final Input input = new StubInput(new String[]{"Please choose menu number", "0", "test1", "Please choose menu number", "6"});
    ...
    public void testGetsTwoItems() {
        ...
        new StartUI(tracker, new StubInput(new String[]{"Please choose menu number", "1", "Please choose menu number", "6"}));
    ...
    public void testsAfterEditItemHasNew() {
        ...
        new StartUI(tracker, new StubInput(new String[]{"Please choose menu number", "2", id, "test2", "Please choose menu number", "6"})).init();
    ...
    public void addOneDeleteOneAndTestItemsIsEmpty() {
        ...
        tracker.add(new Item("test1"));
        final String id = tracker.findAll()[0].getId();
        new StartUI(tracker, new StubInput(new String[]{"Please choose menu number", "3", id, "Please choose menu number", "6"})).init();
    ...
    public void addOneItemAndSearchItemById() {
        ...
        tracker.add(new Item("test1"));
        final String id = tracker.findAll()[0].getId();
        new StartUI(tracker, new StubInput(new String[]{"Please choose menu number", "4", "Please choose menu number", "6"})).init();
    }
    ...
    public void testMenuOutExceptio() {
        final Tracker tracker = new Tracker();
        new StartUI(tracker, new StubInput(new String[]{"Please choose menu number", "7"})).init();
    }
}